// Catalogue de 100 biens pour Espoir Immobilier c�te d'Ivoire
...
export const MOCK_USERS_LIST = [
  ...
  { id: 'u3', name: 'Aubry Admin', email: 'admin@espoirimmobilierctedivoire.cm', role: 'admin', status: 'Actif', joinDate: '01/01/2026' }
];
